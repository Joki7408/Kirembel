 ...
 */
function createPage() {
    let scriptEle: HTMLElement = document.createElement("div");
 ...
 * @returns scriptEle
 */
function createRow(scriptEle: HTMLElement): HTMLElement {
    //createImage();
    ...
    images.forEach((source: string) => {
            ...
            let frame: HTMLElement = createImage(source,counter)
 ...
 */
function createImage(source: string, counter: number): HTMLElement {
    const imgFrame: HTMLElement = document.createElement("div");
 ...
 * @returns 
 */
function clickImg(source: string, text: string) {
    //const bigFrame = document.createElement("div");
    const docFrame: HTMLElement | null = document.getElementById("bigFrame");
...
const images: string[] = ["../../resources/images/image_single_img/001_zugang_zum_ich_2.png",
